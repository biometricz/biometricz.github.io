...
A.fft = hi_res ? 2048 : 256, A.max = 200, A.min = 100, A.rms = 0, S.divisible = divisible(A.fft / 4), S.w = window.innerWidth, S.h = window.innerHeight, hi_res && (S.w *= 2, S.h *= 2), S.w_rad = S.w / 2, S.h_rad = S.h / 2, 
